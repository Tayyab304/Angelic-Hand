...
if(mysqli_num_rows($result)>0){
	...
	$query = "insert into volunteer(user_id,first_name,last_name,mobile_number,password,proviance,city,address,organization_name,
	org_volunteer_id) 
	values('".$user_id."','".$fname."','".$lname."','".$num."','".$pass."','".$proviance."','".$city."','".$add."','".$org."','".$vol_no."');";
	$result  = mysqli_query($con,$query);
